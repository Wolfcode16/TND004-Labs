...
// Return a pointer to the graph
std::unique_ptr<Graph> readGraph(const std::string& fileName) {
    std::ifstream file{"C:/Users/Jovan/Desktop/University/1.Programming/02. TND004 (Data structure)/Labs/Lab4/lab4/code/code4b/" + fileName};  // modify the file path, if needed (Mac)
